<style lang="postcss">
    ...
    .top-search {
        ...
        &:hover, &:active, &:focus {
            ...
            transition: background-color 0.3s;
            box-shadow: none;
            background-color: var(--search-box-hover);
        }
    }
            ...
            <b-container>
                ...
                <b-collapse is-nav id="nav_collapse">
                    ...
                    <b-navbar-nav class="ml-auto">
                        ...
                        <ul class="navbar-nav ml-auto justify-content-end text-right header-user-bar">
                            <b-nav-item-dropdown>
                            ...
                            <b-nav-item-dropdown>
                                <template class="dropdown-menu-right" slot="button-content">
                                    <i class="icon-user"></i>
                                </template>
                                <b-dropdown-item href="#">Giris</b-dropdown-item>
                                <b-dropdown-item href="#">Kayit</b-dropdown-item>
                            </b-nav-item-dropdown>
                        </ul>
